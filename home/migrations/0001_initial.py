# Generated by Django 2.2.7 on 2019-12-01 09:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.child_sub_category')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('invoices', models.FileField(upload_to=home.models.change_file_path, validators=[home.validations.validate_file_extension], verbose_name='Invoices')),
                ('proposals', models.FileField(upload_to=home.models.change_file_path, validators=[home.validations.validate_file_extension], verbose_name='Proposals')),
                ('date_time', models.DateField(blank=True, null=True, verbose_name='Actual BRS Start Date')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer_invoice_and_proposals', to='home.Customer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modified', models.DateField(default=None, null=True)),
                ('file_size', models.CharField(max_length=20)),
                ('design_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.child_sub_category')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('design_name', models.CharField(max_length=30, verbose_name='Design project Name')),
                ('design_images', models.FileField(upload_to=home.models.content_file_name)),
                ('date_time', models.DateField(blank=True, null=True, verbose_name='Actual BRS Start Date')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer_designs', to='home.Customer')),
                ('design_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.child_sub_category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('slots_booked', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='home.Appointment')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            ...
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customer_appointment', to='home.Customer'),
        ),
        migrations.AddField(
            model_name='appointment',
            name='user',
